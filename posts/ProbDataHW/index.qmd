---
title: "A Solution for Probability and Data Homework"
...
The document can be directly [linked in a Tufte book form.](img/data-examples.html).  The quarto rendering here is not perfect.

The document can also be directly [linked as a Tufte html document](img/Tufte2.html).
...
The document can be directly [linked to.](img/data-examples.html).  The quarto rendering here is not perfect.

The document can be directly [linked to.](img/Tufte2.html).
