...
## Michelin and Normals

3.  Graph the Michelin-calibrated Normal($\mu$ = 96,000, $\sigma$ =
...
## A Calibrated Warranty

Suppose that Michelin management would like to set the mileage
...
## An Aside on the Lognormal and Black-Scholes-Merton

- Prices must be positive.
- Logarithms and cumulative returns.
...
## Revisiting a Homework Problem {background-image="img/RadiantSimulate.png" background-size="contain"}

Model.  
Simulation.  
Three Binomials.  
(0.8) Good working order.  
(0.1) Wearing Down.  
(0.1) In Need of Repair.  
Add each.  
Simulate.  
